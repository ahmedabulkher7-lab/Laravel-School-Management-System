    ...
    <div class="card-body">
        <form action="{{ route('admin.schedules.update', $schedule) }}" method="POST">
            ...
            <div class="grid-2">
                <div class="form-group">
                    ...
                    <select name="teacher_id" id="teacher_select" class="form-select" required onchange="updateSubjects()">
                        ...
                        @foreach($teachers as $teacher)
                            <option value="{{ $teacher->id }}" data-subject="{{ $teacher->subject_id }}" {{ old('teacher_id', $schedule->teacher_id) == $teacher->id ? 'selected' : '' }}>
                ...
                <input type="hidden" name="subject_id" id="subject_id" value="{{ old('subject_id', $schedule->subject_id) }}">
            </div>
