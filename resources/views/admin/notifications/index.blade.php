...
<div class="page-header">
    ...
    <form action="{{ route('admin.notifications.markAllRead') }}" method="POST">
        @csrf
        <button type="submit" class="btn-secondary">تحديد الكل كمقروء</button>
    </form>
</div>
    ...
    <div class="card-body" style="padding:0;">
        @forelse($notifications as $notif)
            <div style="padding:1rem 1.5rem;border-bottom:1px solid rgba(12, 114, 97, 0.2);display:flex;justify-content:space-between;align-items:center;">
                ...
                <a href="{{ route('admin.notifications.read', $notif->id) }}" class="btn-secondary" style="padding:0.3rem 0.6rem;font-size:0.75rem;">
                    تحديد كمقروء
                </a>
                @endif
            </div>
